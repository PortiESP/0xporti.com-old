...
import {Title, Title2, Title3, Title4, Link, Paragraph, UList, Img, Callout, Code, Page, Quote, Url, Toggle, Block, Hr, Section} from "@/components/MarkupWidgets/Tags.js"
...
export default (
    <>
        ...
        <Title3>Pre-setup steps</Title3>
            ...
            <Page title="Easy setup" small description={<>Install Arch using <Code inline>archinstall</Code> command</>}>
                <Paragraph>
            ...
            <Page title="Manual setup" small description={<>Install Arch by configuring everything by hand</>}>
                <Paragraph>
