        ...
        <header className={sass.header} style={{background: props.bg}}>
            ...
            <nav className={sass.nav}>
                ...
                <div className={[sass.div__nav_items, !hamburger && sass.hide].join(" ")}>
                    ...
                    <Link href="/blog"><div className={sass.div__nav_item} style={{"--color": "#ff2"}} >BLOG</div></Link>
                    <Link href="/contact"><div className={sass.div__nav_item} style={{"--color": "#0af"}} >CONTACT</div></Link>
                    <Link href="/resources"><div className={sass.div__nav_item} style={{"--color": "#b006f0"}} >RESOURCES</div></Link>
                    <Link href="/"><div className={sass.div__nav_item} style={{"--color": "#f00"}} >HOME</div></Link>
                </div>
            </nav>
